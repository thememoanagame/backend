...
using MemoAna.UnitTests.Common.Mocks;
using Mediator;
...
public sealed class MemoAnaBackendTestFixture : IDisposable
{
    ...
    public MemoAnaBackendTestFixture()
    {
        ...
        _ = services.AddDbContext<SQLiteDbContext>(options =>
        ...
        _ = services.Configure<JwtOptions>(options =>
        {
            ...
            options.Issuer = "MemoAna.Tests";
            options.Audience = "MemoAna.Tests";
        });
    ...
    public SQLiteDbContext DbContext => _provider.GetRequiredService<SQLiteDbContext>();
