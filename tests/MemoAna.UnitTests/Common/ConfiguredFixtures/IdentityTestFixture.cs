...
using MemoAna.UnitTests.Common.Helpers;
using Microsoft.AspNetCore.Identity;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.DependencyInjection;
using System.Security.Cryptography;

namespace MemoAna.UnitTests.Common.ConfiguredFixtures;
...
public sealed class IdentityTestFixture : IDisposable
{
    ...
    public IdentityTestFixture()
    {
        ...
        _ = services.AddDbContext<SQLiteDbContext>(options => options.UseInMemoryDatabase(Guid.NewGuid().ToString("N")));
        ...
        {
            options.Key = "MemoAna-test-secret-key-with-at-least-256-bits-2026";
            options.Issuer = "MemoAna.Test";
            options.Audience = "MemoAna.Test";
        ...
        _ = _provider.GetRequiredService<SQLiteDbContext>().Database.EnsureCreated();
    }
    ...
    public async Task<string> GenerateValidAuthenticatorCodeAsync(User user)
    {
        ...
        long timestep = DateTime.UtcNow.ToUnixTimeSeconds() / 30;
