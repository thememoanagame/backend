        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ThumbnailId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LiteDbImageId = table.Column<string>(type: "TEXT", maxLength: 50, nullable: false),
                    IsFlipped = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    IsMatched = table.Column<bool>(type: "INTEGER", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    CreatedBy = table.Column<string>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedBy = table.Column<string>(type: "TEXT", nullable: false)
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UQ_Cards_Room_Position",
                table: "Cards",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UQ_Themes_Name",
                table: "Themes",
                column: "Name",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UQ_Themes_ThumbnailId",
                table: "Themes",
                column: "ThumbnailId",
                unique: true);
