...
- `MemoAna` — Presentation / Web API + Blazor Interactive Server.
- `MemoAna.Application` — Application use cases, contracts, requests, responses, handlers and validation.
- `MemoAna.Composition` — Composition root and dependency injection registration.
- `MemoAna.Domain` — Domain model and domain abstractions.
- `MemoAna.Infrastructure` — persistence and external integrations/implementations.
